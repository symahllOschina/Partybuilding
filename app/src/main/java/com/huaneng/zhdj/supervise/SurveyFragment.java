...
import com.huaneng.zhdj.adapter.SurveyAdapter;
import com.huaneng.zhdj.bean.Survey;
import com.huaneng.zhdj.bean.SurveyPager;
 ...
 * 民意调查
 */
@ContentView(R.layout.fragment_survey)
public class SurveyFragment extends BaseRefreshFragment<Survey> {//
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        adapter = new SurveyAdapter(activity, mList);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("survey", mList.get(i));
    ...
    public void getList() {
        ...
        HTTP.service.get("survey/list", MapParam.me().p("page", mPager.nextPage()).p("size", mPager.size).p("title", keywords).build())
                ...
                .subscribe(new Subscriber(activity){
                    ...
                    public void onSuccess(Response response) {
                        SurveyPager pager = response.getEntity(SurveyPager.class);
