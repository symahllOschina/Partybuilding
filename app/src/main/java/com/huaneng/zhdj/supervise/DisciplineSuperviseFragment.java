 ...
 * 纪律监督
 */
@ContentView(R.layout.fragment_discipline_supervise)
public class DisciplineSuperviseFragment extends BaseRefreshFragment<News> {//
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(activity, DisciplineSuperviseDetailActivity.class);
    ...
    public void getList() {
        ...
        HTTP.service.get("discip/list", MapParam.me().p("page", mPager.nextPage()).p("size", mPager.size).build())
