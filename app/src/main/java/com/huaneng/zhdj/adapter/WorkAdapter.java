...
public class WorkAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Work entity = mList.get(position);
        UIUtils.showText(viewHolder.titleTv, entity.title);
        UIUtils.showText(viewHolder.userNameTv, entity.user_name);
        UIUtils.showText(viewHolder.typeTv, Utils.emptyIfNull(Data.work_type.get(entity.type)));
        UIUtils.showText(viewHolder.timeTv, DateUtils.getDate(entity.update_time));
