 ...
 * 附件-文章Adapter
 */
public class AttachmentArticleAdapter extends BaseAdapter {

    private Context mContext;

    private List<Attachment> mList = null;

    public AttachmentArticleAdapter(Context context, List<Attachment> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_attachment_article, null);
