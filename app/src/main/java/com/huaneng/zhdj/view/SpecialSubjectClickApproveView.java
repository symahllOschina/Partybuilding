 ...
 * 专题点击量、点赞View
 */
public class SpecialSubjectClickApproveView extends LinearLayout {
    ...
    public void init(BaseActivity ctx, String articleId) {
        approveView.init(ctx, articleId, new SpecialSubjectApprove());
    }

    public SpecialSubjectClickApproveView(Context context) {
        super(context);
    }

    public SpecialSubjectClickApproveView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SpecialSubjectClickApproveView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public SpecialSubjectClickApproveView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
