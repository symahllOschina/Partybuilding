 ...
 * 时代先锋-文章-点赞
 */
public class PioneersArticleApprove extends BaseApprove {

    /**
     * 检查是否已点赞
     */
    public void checkIsUpvote(String articleId) {
        HTTP.service.get("upvote/read", MapParam.me().p("id", articleId).build())
    ...
    public void upvote(String articleId, Integer isUpvote) {
        ...
        HTTP.service.post("upvote/save", MapParam.me().p("id", articleId).build())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber(ctx){
    ...
    public void delUpvote(String articleId) {
        ...
        HTTP.service.post("upvote/delete", MapParam.me().p("id", articleId).build())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber(ctx){
