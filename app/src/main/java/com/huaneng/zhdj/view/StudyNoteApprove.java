 ...
 * 学习笔记-点赞
 */
public class StudyNoteApprove extends BaseApprove {

    /**
     * 检查是否已点赞
     */
    public void checkIsUpvote(String articleId) {
        HTTP.service.get("schoolnote/upvoteread", MapParam.me().p("id", articleId).build())
    ...
    public void upvote(String articleId, Integer isUpvote) {
        ...
        HTTP.service.post("schoolnote/upvotesave", MapParam.me().p("id", articleId).build())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber(ctx){
    ...
    public void delUpvote(String articleId) {
        ...
        HTTP.service.post("schoolnote/upvotedelete", MapParam.me().p("id", articleId).build())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber(ctx){
