 ...
 * 时代先锋-作品-点赞
 */
public class PioneersWorksApprove extends BaseApprove {

    /**
     * 检查是否已点赞
     */
    public void checkIsUpvote(String articleId) {
        HTTP.service.get("worksok/read", MapParam.me().p("id", articleId).build())
    ...
    public void upvote(String articleId, Integer isUpvote) {
        ...
        HTTP.service.post("worksok/save", MapParam.me().p("id", articleId).build())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber(ctx){
    ...
    public void delUpvote(String articleId) {
        ...
        HTTP.service.post("worksok/delete", MapParam.me().p("id", articleId).build())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber(ctx){
