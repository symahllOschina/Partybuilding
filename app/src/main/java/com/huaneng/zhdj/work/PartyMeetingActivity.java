...
import com.huaneng.zhdj.adapter.MeetingAdapter;
...
// 党务办公 -- 会议列表
@ContentView(R.layout.activity_party_meeting)
public class PartyMeetingActivity extends BaseRefreshActivity<Meeting> {//
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("会议列表");
        adapter = new MeetingAdapter(ctx, mList);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(ctx, PartyMeetingDetailActivity.class);
    ...
    public void getList() {
        ...
        String condition = (checkedIndex == -1)?"0,1,2,3,4,5,6" : (checkedIndex + "");
