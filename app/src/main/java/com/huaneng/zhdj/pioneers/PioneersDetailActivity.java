 ...
 * 时代先锋 -- 新闻详情
 */
@ContentView(R.layout.activity_pioneers_detail)
public class PioneersDetailActivity extends BaseActivity {
    ...
    private PioneersArticleClickApproveView clickApproveCountView;
                ...
                .subscribe(new Subscriber(ctx){
                    ...
                    public void onSuccess(Response response) {
                        ...
                        if (detail != null) {
                            ...
                            String authorLabel = getIntent().getStringExtra("authorLabel");
                            boolean authorVisible = getIntent().getBooleanExtra("authorVisible", false);
                            boolean fromVisible = getIntent().getBooleanExtra("fromVisible", false);
                            if (authorVisible) {
                                newsInfoView.setAuthor(authorLabel, news.author);
                            }
                            if (fromVisible) {
